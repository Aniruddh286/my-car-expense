...
class ExpenseProvider with ChangeNotifier {
  ...
  // Future getDatewiseTotalExpense(DateTime startTime, DateTime endTime) async {
  //   return await firestoreService.getDatewiseTotalExpense(startDate, endDate);
  // }

  // Future getDatewiseTotalIncome(DateTime startTime, DateTime endTime) async {
  //   return await firestoreService.getDatewiseTotalIncome(startDate, endDate);
  // }
}
